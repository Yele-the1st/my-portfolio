    ...
    <Typewriter
      ...
      onInit={(typewriter) => {
        typewriter
          ...
          .typeString("<span class='text-red-500'>Salesman</span>, ")
          .typeString("<span class='text-red-500'>Speaker</span>, ")
          .typeString("<span class='text-red-500'>Writer</span>, ")
          .typeString("<span class='text-red-500'>Founder</span>,<br>")
          .typeString("<span class='pl-5'></span>")
          .typeString("<span class='text-red-500'>Sugar</span>, ")
          .typeString("<span class='text-red-500'>Spice</span>, ")
          .typeString(
            "<span class='text-red-500'>...everythingNice</span>,<br>"
          )
          .typeString("];")
          .start();
      }}
